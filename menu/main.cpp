...
// 			uint32_t *d = (uint32_t*) sal_VideoGetBuffer() + (SAL_SCREEN_WIDTH - SNES_WIDTH)/4 + (SAL_SCREEN_HEIGHT - h) * 160;
...
// 			// uint32_t h = PAL ? SNES_HEIGHT_EXTENDED : SNES_HEIGHT;
// 			// uint32_t y, pitch = sal_VideoGetPitch();
// 			// uint8_t *src = (uint8_t*) IntermediateScreen, *dst = (uint8_t*) sal_VideoGetBuffer()
// 			// 	+ ((sal_VideoGetWidth() - SNES_WIDTH) / 2) * sizeof(uint16_t)
// 			// 	+ ((sal_VideoGetHeight() - h) / 2) * pitch;
// 			// for (y = 0; y < h; y++)
// 			// {
// 			// 	memmove(dst, src, SNES_WIDTH * sizeof(u16));
// 			// 	src += SNES_WIDTH * sizeof(uint16_t);
// 			// 	dst += pitch;
// 			// }
// 			// break;
...
// 				upscale_256x240_to_320x240_bilinearish((uint32_t*) sal_VideoGetBuffer() + (SAL_SCREEN_HEIGHT - h) * 160, (uint32_t*) IntermediateScreen, SNES_WIDTH);
// 			// } else {
// 				// upscale_256x240_to_320x240_bilinearish((uint32_t*) sal_RS97VideoGetBuffer() + (SAL_SCREEN_HEIGHT - h) * 160, (uint32_t*) IntermediateScreen, SNES_WIDTH);
// 			// }
// 			break;
...
// 	GFX.RealPitch = GFX.Pitch = SNES_WIDTH * sizeof(u16);
